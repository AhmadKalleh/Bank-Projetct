...
private:
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        LoginRegisterRecord.DateTime = TransferLogDataLine[0];
        LoginRegisterRecord.SourceAccountNumber = TransferLogDataLine[1];
        LoginRegisterRecord.DestinationAccountNumber = TransferLogDataLine[2];
        LoginRegisterRecord.Amount = stof(TransferLogDataLine[3]);
        LoginRegisterRecord.SourceBalance = stof(TransferLogDataLine[4]);
        LoginRegisterRecord.DestinationBalance = stof(TransferLogDataLine[5]);
        LoginRegisterRecord.UserName = TransferLogDataLine[6];
    ...
    void RegisterTransferLog(clsBankClient DestinationClient, float Amount, string UserName)
    {
